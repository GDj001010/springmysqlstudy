...
public class UploadController {
	...
	public String update(MultipartHttpServletRequest multipartRequest, RedirectAttributes redirectAttributes) {
		int uploadResult = uploadService.updateUpload(multipartRequest);
		redirectAttributes.addFlashAttribute("updateResult", uploadResult);
